...
<head>
	...
	<link rel="stylesheet" href="<?= base_url('assets/assets/vendors/iconly/bold.css') ?>">
	<link rel="stylesheet" href="<?= base_url('assets/assets/vendors/perfect-scrollbar/perfect-scrollbar.css') ?>">
	<link rel="stylesheet" href="<?= base_url('assets/assets/vendors/bootstrap-icons/bootstrap-icons.css') ?>">
